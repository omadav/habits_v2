...
expName = u'joystick_test'  # from the Builder filename that created this script
expInfo = {u'session': u'001', u'participant': u'2', u'interval': u'5', u'schedule': u'RI'}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'C:\\Users\\omada\\Dropbox\\Projects\\Caltech\\Humans\\Habits\\Caltech 2018-2 (Anastasia)\\Task\\joystick_test.psyexp',
...
shouldBeReinforced_txt = visual.TextBox(window=win, text=' ', font_size=20,
                         font_color=[-1, -1, 1], size=(1.9, .3), pos=(-0.7, 0.4), 
                         grid_horz_justification='center', units='norm')

reward_txt = visual.TextBox(window=win, text='reward!', font_size=30,
                         font_color=[1, 1, 1], size=(1.9, .3), pos=(0.0, 0.6), 
                         grid_horz_justification='center', units='norm')
...
for thisTrial in trials:
    ...
    stim.setImage(machine)
    # Parameters for the RI 
