...
expInfo = {u'session': u'1', u'participant': u'01', u'interval': u'10', u'schedule': u'RI'}
...
final_txt_1 = visual.TextStim(win=win, name='final_txt_1',
    text=u'End of the experiment. Thanks for participating!\n\nYour total earning for today was',
    font=u'Comic Sans',
    pos=(0, 0), height=0.06, wrapWidth=None, ori=0, 
    color=u'black', colorSpace='rgb', opacity=1,
    depth=-6.0);
...
# update component parameters for each repeat
# keep track of which components have finished
instr_2_4Components = [instr_2_4_txt]
...
continueRoutine = True
# update component parameters for each repeat
text.setText((credits/10))
key_resp_12 = event.BuilderKeyResponse()
# keep track of which components have finished
goodbyeComponents = [final_txt_1, text, key_resp_12]
...
while continueRoutine:
    ...
    if final_txt_1.status == STARTED and t >= frameRemains:
        final_txt_1.setAutoDraw(False)
