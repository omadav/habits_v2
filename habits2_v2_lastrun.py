...
expInfo = {u'participant': u'01', u'credits_per_rnf': u'0.25', u'schedule': u'RI', u'interval': u'5', u'session': u'2', u'experimenter': u'o'}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'C:\\Users\\omadav\\Dropbox\\Projects\\Caltech\\Humans\\Habits\\Caltech 2018-2 (Anastasia)\\Task\\habits2_v2.psyexp',
...
instr_test_txt = visual.TextStim(win=win, name='instr_test_txt',
    text='\nIn this experiment you will be using your joystick to earn either gold or silver coins.\n\nThe coins will be cashed for real money at the end of the experiment.\n\nEach coin you win, either silver or gold, will give you 0.25 dollars. Therefore, both silver and gold coins are worth the same amount.\n\n\n\n\n\n\n\n\n\n\n(Press any key to continue)\n',
    font='Comic Sans',
...
instr2_3_txt = visual.TextStim(win=win, name='instr2_3_txt',
    text='Every time you perform the action that corresponds to the stimulus shown on the screen, a triangle will appear at the center of the screen signalling that the relevant response has been made. \n\nYou may receive a reward (silver or gold coin) for performing the action which corresponds to the stimulus shown on the screen. \n\nTwo of the actions (for ex., left and right) will give you gold coins when you are rewarded; the other two (for ex., up and down) will give you silver coins when you are rewarded. \n\nWe will be collecting the silver and gold coins you win in two piggy banks outside the room, one for the silver coins and one for the gold coins. \n\nRemember: both gold and silver coins are worth the same: 0.25 dollars.\n\n\n\n\n\n\n\n\n\n(Press any key to continue)\n',
    font='Comic Sans',
    pos=(0, 0), height=0.06, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1,
    depth=0.0);
...
instr_2_4_txt = visual.TextStim(win=win, name='instr_2_4_txt',
    text='Given the nature of the task, not every correct joystick action you make during each trial will be rewarded.\n\nIn fact, there is a best way to perform the correct joystick action in order to win the most rewards with the least cost. But you need to discover this yourself!\n\n\n\n\n\n\n\n\n\n\nPlease call the experimenter now to start the experiment.',
    font='Comic Sans',
    pos=(0, 0), height=0.06, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1,
    depth=0.0);
...
def resp_made():
    global credits # credits var updates troughout the experiment
...
instr_devaluation_txt = visual.TextStim(win=win, name='instr_devaluation_txt',
    text='The following piggy bank:\n\n\n\n\n\nis now full. No further coins can be deposited in this piggy bank.\n\n\n\n\n',
    font='Comic Sans',
    pos=(0, 0), height=0.06, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1,
    depth=0.0);
...
instr_devaluation_txt_3 = visual.TextStim(win=win, name='instr_devaluation_txt_3',
    text='On the next screen you will have the chance to collect gold and silver coins by clicking the mouse on them. \n\nWe will deposit the collected coins into their respective piggy banks.\n\nYou will have 8 secs to collect as much as you want from each type of coin.  ',
    font='Comic Sans',
    pos=(0, 0), height=0.06, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1,
    depth=0.0);
...
gold3 = visual.ImageStim(
    win=win, name='gold3',
    image='stim/gold_coin.png', mask=None,
    ori=0, pos=(0.15, 0.6), size=(0.2, 0.2),
    color=[1,1,1], colorSpace='rgb', opacity=1.0,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=-3.0)
...
gold7 = visual.ImageStim(
    win=win, name='gold7',
    image='stim/gold_coin.png', mask=None,
    ori=0, pos=(-0.6, 0.6), size=(0.2, 0.2),
    color=[1,1,1], colorSpace='rgb', opacity=1.0,
    flipHoriz=False, flipVert=False,
...
silver5 = visual.ImageStim(
    ...
    image='stim/silver_coin.png', mask=None,
    ori=0, pos=(0, 0.8), size=(0.22, 0.22),
    color=[1,1,1], colorSpace='rgb', opacity=1.0,
    flipHoriz=False, flipVert=False,
...
silver9 = visual.ImageStim(
    ...
    image='stim/silver_coin.png', mask=None,
    ori=0, pos=(0.85, -0.85), size=(0.22,0.22),
    color=[1,1,1], colorSpace='rgb', opacity=1.0,
    flipHoriz=False, flipVert=False,
...
instr_devaluation_txt_2 = visual.TextStim(win=win, name='instr_devaluation_txt_2',
    text='In this last part of the experiment you will have the opportunity to perform two actions during a trial.\n\nThe allowed actions will be signalled by their respective stimuli.\n\nFor example, if you see the stimuli below you will be allowed to make left and up responses.\n\n\n\n\n\n\n\n\nThis time we will not show you the coins you are earning, the flashing triangle, nor the credits you have so far. But keep in mind that everything continues the same as before. We will keep inserting the coins you win in their respective piggy banks.\n\n \n',
    font='Comic Sans',
    pos=(0, 0), height=0.06, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1,
    depth=0.0);
...
trials = data.TrialHandler(nReps=1, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('conditions2.xlsx', selection='0:10'),
...
# (the devaluation is done at the end of the 2nd day)
...
if thisChoice_block != None:
    for paramName in thisChoice_block.keys():
        exec(paramName + '= thisChoice_block.' + paramName)
...
for thisChoice_block in choice_block:
    ...
    # keep track of which components have finished
    instr_testComponents = [instr_devaluation_txt, devalued_piggy_bank_txt, key_resp_5]
    ...
    trials_2 = data.TrialHandler(nReps=1, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('conditions2.xlsx', selection='10:12'),
