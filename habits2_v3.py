...
expInfo = {u'participant': u'01', u'credits_per_rnf': u'25', u'schedule': u'RI', u'interval': u'10', u'session': u'1', u'experimenter': u'o', u'cost_response': u'1'}
...
trian_img = visual.ImageStim(
    ...
    image=u'stim/triangle_img.png', mask=None,
...
coin1_img = visual.ImageStim(
    ...
    image=u'stim/silver_coin.png', mask=None,
    ori=0, pos=(-0.2, -0.2), size=(0.25, 0.25),
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=-3.0)
coin2_img = visual.ImageStim(
    win=win, name='coin2_img',
    image=u'stim/gold_coin.png', mask=None,
    ori=0, pos=(0.2, -0.2), size=(0.25, 0.25),
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
...
instr_2_3_1_txt = visual.TextStim(win=win, name='instr_2_3_1_txt',
    text=u'During each trial, the coin, either silver or gold, will flash at the center of the screen when you are rewarded. If they are not already full, We will be collecting these coins in two different piggy banks outside the room, one for the silver coins and one for the gold coins. \n\nRemember: both gold and silver coins are worth the same.\n\n\n(Press any key to continue)',
    font=u'Comic Sans',
...
for thisTrial_3 in trials_3:
    ...
    trials = data.TrialHandler(nReps=1, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('conditions3.xlsx', selection=u'0:6'),
...
payout_this_session = nReinforcers*float(expInfo['credits_per_rnf']) - nResp*float(expInfo['cost_response'])
