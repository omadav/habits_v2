...
expInfo = {u'participant': u'00', u'schedule': u'RI', u'interval': u'15', u'session': u'1', u'experimenter': u'o', u'devalued': u'gold'}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'C:\\Users\\omadav\\Dropbox\\Projects\\Caltech\\Humans\\Habits\\Caltech 2018-2 (Anastasia)\\Task\\habits_2_v1.psyexp',
...
def checkRnf():
    ...
    if shouldBeReinforced:
        ...
        credits += 25
        reward_sound.play()
        for frameN in range(50): # show for half a sec
            #reward_txt.draw()
...
trials = data.TrialHandler(nReps=5, method='random', 
    ...
    trialList=data.importConditions('conditions.xlsx', selection=u'0:10'),
...
for thisChoice_block in choice_block:
    ...
    trials_2 = data.TrialHandler(nReps=3, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('conditions.xlsx', selection=u'10:12'),
...
# get names of stimulus parameters
if choice_block.trialList in ([], [None], None):
    params = []
else:
    params = choice_block.trialList[0].keys()
# save data for this loop
choice_block.saveAsExcel(filename + '.xlsx', sheetName='choice_block',
    stimOut=params,
    dataOut=['n','all_mean','all_std', 'all_raw'])
choice_block.saveAsText(filename + 'choice_block.csv', delim=',',
    stimOut=params,
    dataOut=['n','all_mean','all_std', 'all_raw'])
...
continueRoutine = True
# update component parameters for each repeat
credits_txt.setText(str((credits/10)) + ' dollars')
